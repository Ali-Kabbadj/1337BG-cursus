...
/*   Updated: 2023/02/26 14:45:47 by akabbadj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (key == K_R)
		fract->vars.colors.red += 10;
	else if (key == K_G)
		fract->vars.colors.green += 10;
	else if (key == K_B)
		fract->vars.colors.blue += 10;
	else if (key == K_T)
		fract->vars.colors.transparency += 10;
}
